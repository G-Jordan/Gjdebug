...
(function(){
  function toInputId(key){
    return {
      ...
      likeColor: "likeColorPicker",
      dislikeColor: "dislikeColorPicker",
  ...
  function saveTheme(){
    ...
    const map = { mainColor: ids[0], accentColor: ids[1], textColor: ids[2], textBg: ids[3], borderColor: ids[4], artistColor: ids[5], likeColor: ids[6], dislikeColor: ids[7], downloadColor: ids[8] };
    const theme = {};
