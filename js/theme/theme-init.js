...
(function(){
  ...
  try {
    ...
    if (theme.likeColor) cssVars.push(`--like-color: ${theme.likeColor};`);
    if (theme.dislikeColor) cssVars.push(`--dislike-color: ${theme.dislikeColor};`);
    if (theme.downloadColor) cssVars.push(`--download-color: ${theme.downloadColor};`);
